...
public:
	...
	void ChoosePointInCylinder(Vector *param_1); // size[88]
	void RegisterReflection(CPropCombineBall *param_1, boolparam_2); // size[60]
	void GetTargetEndpoint(boolparam_1, Vector *param_2); // size[100]
	void BallGrabbed(CBaseEntity *param_1); // size[44]
	void GetBallSpeed(); // size[52]
	void RespawnBall(floatparam_1); // size[85]
