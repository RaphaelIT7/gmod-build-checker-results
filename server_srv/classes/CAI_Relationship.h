...
public:
	...
	void FindEntityForProceduralName(string_t param_1, CBaseEntity *param_2, CBaseEntity *param_3); // size[76]
	void DiscloseNPCLocation(CBaseCombatCharacter *param_1, CBaseCombatCharacter *param_2); // size[25]
	void ChangeRelationships(int param_1, int param_2, CBaseEntity *param_3, CBaseEntity *param_4); // size[1870]
