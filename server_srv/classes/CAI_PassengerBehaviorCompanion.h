...
public:
	...
	void CanEnterVehicleImmediately(int *param_1, Vector *param_2, QAngle *param_3); // size[1659]
	void EnterVehicleImmediately(); // size[85]
	...
	void GetArcToEntryPoint(Vector *param_1, Vector *param_2, bool *param_3); // size[213]
	void ResetVehicleEntryFailedState(); // size[18]
	void PointIsWithinEntryFailureRadius(Vector *param_1); // size[665]
	void CalculateBodyLean(); // size[139]
	void GatherVehicleCollisionConditions(Vector *param_1); // size[1]
	...
	void MarkVehicleEntryFailed(Vector *param_1); // size[35]
	void FindPathToVehicleEntryPoint(); // size[19]
	void InitCustomSchedules(); // size[295]
	void LoadSchedules(); // size[62]
	CScheduleLoader(); // size[9]
	CAI_PassengerBehaviorCompanion(); // size[25]
};
