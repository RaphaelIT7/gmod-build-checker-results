...
public:
	...
	virtual void OnPhysGunPickup(CBasePlayer *param_1, PhysGunPickup_tparam_2); // vtable[664]
	virtual void OnPhysGunDrop(CBasePlayer *param_1, PhysGunDrop_tparam_2); // vtable[665]
	...
	void TakeDamageFromVehicle(intparam_1, gamevcollisionevent_t *param_2); // size[667]
	void TakeDamageFromPhysicsImpact(intparam_1, gamevcollisionevent_t *param_2); // size[714]
	void CreateSmokeTrail(); // size[145]
	void DestroySmokeTrail(); // size[69]
	void IsFlyingActivity(Activityparam_1); // size[42]
	void Loiter(); // size[531]
	void MaintainGroundHeight(); // size[151]
	void TurnHeadRandomly(floatparam_1); // size[102]
	...
	void Bump(CBaseEntity *param_1, floatparam_2, CGameTrace *param_3); // size[2024]
	void SpinBlades(floatparam_1); // size[542]
	void SoundInit(); // size[48]
	void StartEngine(boolparam_1); // size[117]
	void BladesInit(); // size[122]
	void ManhackMaxSpeed(); // size[100]
	void KillSprites(floatparam_1); // size[262]
	...
	void UpdatePanels(); // size[501]
	void ShowHostile(boolparam_1); // size[84]
	void StartBurst(Vector *param_1); // size[161]
	void StopBurst(boolparam_1); // size[154]
	void Slice(CBaseEntity *param_1, floatparam_2, CGameTrace *param_3); // size[1537]
	void CheckCollisions(floatparam_1); // size[502]
	void StartEye(); // size[765]
	void SetEyeState(intparam_1); // size[1872]
	...
	void PlayFlySound(); // size[869]
	void MoveExecute_Alive(floatparam_1); // size[2532]
	void MoveExecute_Dead(floatparam_1); // size[1308]
	void InitCustomSchedules(); // size[352]
	void LoadSchedules(); // size[62]
	CScheduleLoader(); // size[9]
	CNPC_Manhack(); // size[200]
