...
public:
	...
	void Bump(CBaseEntity *param_1, float param_2, CGameTrace *param_3); // size[2024]
	...
	void ShowHostile(bool param_1); // size[84]
	void StartBurst(Vector *param_1); // size[161]
	void StopBurst(bool param_1); // size[154]
	void Slice(CBaseEntity *param_1, float param_2, CGameTrace *param_3); // size[1537]
	void CheckCollisions(float param_1); // size[502]
	void StartEye(); // size[765]
	void SetEyeState(int param_1); // size[1872]
	...
	void MoveExecute_Alive(float param_1); // size[2532]
