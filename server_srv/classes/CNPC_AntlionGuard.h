...
public:
	...
	void CreateGlow(int param_1, char *param_2); // size[521]
	void CanSummon(bool param_1); // size[62]
	void ShouldCharge(Vector *param_1, Vector *param_2, bool param_3, bool param_4); // size[1832]
	void GetPhysicsShoveDir(CBaseEntity *param_1, float param_2, Vector *param_3); // size[325]
	...
	void HandleChargeImpact(Vector param_1, CBaseEntity *param_2); // size[683]
