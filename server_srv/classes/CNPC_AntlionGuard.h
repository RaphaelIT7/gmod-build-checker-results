...
public:
	...
	void ShouldCharge(Vector *param_1, Vector *param_2, bool param_3, bool param_4); // size[1810]
	void GetPhysicsShoveDir(CBaseEntity *param_1, float param_2, Vector *param_3); // size[234]
