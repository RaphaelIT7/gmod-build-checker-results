// Generated header
// Estimated minimum size: 0x269C (9884) bytes
...
public:
	...
	void ShouldCharge(Vector *param_1, Vector *param_2, bool param_3, bool param_4); // size[1825]
	void GetPhysicsShoveDir(CBaseEntity *param_1, float param_2, Vector *param_3); // size[252]
	...
	void SummonAntlions(); // size[1546]
	void FoundEnemy(); // size[62]
	void LostEnemy(); // size[96]
	...
	void Shove(); // size[376]
	void ChargeDamage(CBaseEntity *param_1); // size[251]
	void HandleChargeImpact(Vector param_1, CBaseEntity *param_2); // size[378]
	void StartSounds(); // size[44]
	void GetBleedingLevel(); // size[43]
	void FindPhysicsObjectTarget(PhysicsObjectCriteria_t *param_1); // size[2639]
	void SelectUnreachableSchedule(); // size[1264]
	void SelectUnreachableSchedule(); // size[28]
	void SelectCombatSchedule(); // size[322]
