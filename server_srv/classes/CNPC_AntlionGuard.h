...
public:
	...
	void InputSetChargeTarget(inputdata_t *param_1); // size[145]
	void InputUnburrow(inputdata_t *param_1); // size[85]
	void GetBaseMap(); // size[10]
	void DestroyGlows(); // size[116]
	void CreateGlow(intparam_1, char *param_2); // size[521]
	void CanSummon(boolparam_1); // size[62]
	void ShouldCharge(Vector *param_1, Vector *param_2, boolparam_3, boolparam_4); // size[1832]
	void GetPhysicsShoveDir(CBaseEntity *param_1, floatparam_2, Vector *param_3); // size[325]
	void SetHeavyDamageAnim(Vector *param_1); // size[26]
	void EnemyIsRightInFrontOfMe(CBaseEntity * *param_1); // size[872]
	void ChargeLookAhead(); // size[318]
	...
	void CanStandAtShoveTarget(CBaseEntity *param_1, CBaseEntity *param_2, Vector *param_3); // size[605]
	void GetNextShoveTarget(CBaseEntity *param_1, AISightIter_t__ * *param_2); // size[148]
	void ImpactShock(Vector *param_1, floatparam_2, floatparam_3, CBaseEntity *param_4); // size[537]
	void Shove(); // size[376]
	void ChargeDamage(CBaseEntity *param_1); // size[332]
	void HandleChargeImpact(Vectorparam_1, CBaseEntity *param_2); // size[683]
	...
	void UpdatePhysicsTarget(boolparam_1, floatparam_2); // size[492]
	void RememberFailedPhysicsTarget(CBaseEntity *param_1); // size[157]
	void Footstep(boolparam_1); // size[406]
