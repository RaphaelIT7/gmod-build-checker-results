// Generated header
// Estimated minimum size: 0x568C (22156) bytes, no debug info available
...
public:
	...
	void PlayLiftingScream(float param_1); // size[88]
	...
	void WaitForRagdollToSettle(float param_1); // size[906]
	...
	void AttachTongueToTarget(CBaseEntity *param_1, Vector param_2); // size[143]
