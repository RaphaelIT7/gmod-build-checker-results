...
public:
	...
	virtual void GetCheckInterval(IntervalType_tparam_1) override; // vtable[30]
	...
	void StartForcedMove(boolparam_1, floatparam_2, Vector *param_3, CFuncLadder *param_4); // size[667]
	void ContinueForcedMove(); // size[333]
	void Findladder(floatparam_1, CFuncLadder * *param_2, Vector *param_3, CFuncLadder *param_4); // size[807]
	void CheckLadderAutoMountEndPoint(CFuncLadder *param_1, Vector *param_2); // size[588]
	void CheckLadderAutoMountCone(CFuncLadder *param_1, Vector *param_2, floatparam_3, floatparam_4); // size[1159]
	void LookingAtLadder(CFuncLadder *param_1); // size[542]
	void CheckLadderAutoMount(CFuncLadder *param_1, Vector *param_2); // size[69]
	void GetSortedDismountNodeList(Vector *param_1, floatparam_2, CFuncLadder *param_3, CUtlRBTree *param_4); // size[201]
	void ExitLadderViaDismountNode(CFuncLadder *param_1, boolparam_2, boolparam_3); // size[1512]
};
