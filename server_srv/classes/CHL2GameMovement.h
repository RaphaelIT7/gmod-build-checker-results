...
public:
	...
	void StartForcedMove(bool param_1, float param_2, Vector *param_3, CFuncLadder *param_4); // size[667]
	void ContinueForcedMove(); // size[333]
	void Findladder(float param_1, CFuncLadder * *param_2, Vector *param_3, CFuncLadder *param_4); // size[807]
	...
	void ExitLadderViaDismountNode(CFuncLadder *param_1, bool param_2, bool param_3); // size[1512]
};
