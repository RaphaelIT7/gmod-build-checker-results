...
public:
	...
	void Findladder(float param_1, CFuncLadder * *param_2, Vector *param_3, CFuncLadder *param_4); // size[21]
	...
	void LookingAtLadder(CFuncLadder *param_1); // size[406]
	void ExitLadderViaDismountNode(CFuncLadder *param_1, bool param_2, bool param_3); // size[986]
};
