...
public:
	...
	virtual void Explode(CGameTrace *param_1, intparam_2); // vtable[282]
	...
	virtual void SetDamageRadius(floatparam_1); // vtable[289]

	void _GLOBAL__sub_I_m_DataMap(); // size[112]
	void DetonateUse(CBaseEntity *param_1, CBaseEntity *param_2, USE_TYPEparam_3, floatparam_4); // size[59]
