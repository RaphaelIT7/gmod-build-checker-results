...
public:
	...
	void SetFollowGoalDirect(CAI_FollowGoal *param_1); // size[73]
	void IsMovingToFollowTarget(); // size[99]
	void PlayerIsPushing(); // size[100]
	void IsFollowGoalInRange(float param_1, float param_2, int param_3); // size[386]
	void IsFollowTargetInRange(float param_1); // size[291]
	...
	void ShouldMoveToFollowTarget(); // size[306]
	void ShouldIgnoreFollowPointFacing(); // size[94]
	void SetFollowPoint(CAI_Hint *param_1); // size[319]
	void SelectScheduleFollowPoints(); // size[1338]
	void SelectScheduleMoveToFormation(); // size[289]
	...
	void UpdateFollowPosition(); // size[368]
	...
	void SetFollowGoal(CAI_FollowGoal *param_1, bool param_2); // size[321]
	void ClearFollowGoal(CAI_FollowGoal *param_1); // size[147]
};
