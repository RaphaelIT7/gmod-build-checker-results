// Generated header
// Estimated minimum size: 0x2590 (9616) bytes
...
public:
	...
	void OnHitAssaultPoint(); // size[221]
	void FindBestRallyPointInRadius(Vector *param_1, float param_2); // size[264]
