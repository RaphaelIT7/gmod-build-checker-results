...
public:
	...
	void SetPlayerLaunched(CBasePlayer *param_1); // size[172]
	void GetBallHoldDissolveTime(); // size[105]
	void DissolveRampSoundThink(); // size[174]
	...
	void DeflectTowardEnemy(float param_1, int param_2, gamevcollisionevent_t *param_3); // size[946]
	void IsHittableEntity(CBaseEntity *param_1); // size[143]
