...
public:
	...
	void CollisionEventToTrace(int param_1, gamevcollisionevent_t *param_2, CGameTrace *param_3); // size[34]
	void DissolveEntity(CBaseEntity *param_1); // size[233]
	void IsAttractiveTarget(CBaseEntity *param_1); // size[1075]
	void DeflectTowardEnemy(float param_1, int param_2, gamevcollisionevent_t *param_3); // size[1588]
	...
	void OnHitEntity(CBaseEntity *param_1, float param_2, int param_3, gamevcollisionevent_t *param_4); // size[1513]
