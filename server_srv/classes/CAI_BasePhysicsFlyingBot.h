// Generated header
// Estimated minimum size: 0x2600 (9728) bytes, no debug info available
...
public:
	...
	void Simulate(IPhysicsMotionController *param_1, IPhysicsObject *param_2, float param_3, Vector *param_4, Vector *param_5); // size[533]
	...
	void GetHeadTurnRate(); // size[11]
	void ClampMotorForces(Vector *param_1, Vector *param_2); // size[84]
};
