...
public:
	...
	virtual void TurnHeadToTarget(floatparam_1, Vector *param_2); // vtable[653]
	virtual void __cxa_pure_virtual(); // vtable[654]
	virtual void GetHeadTurnRate(); // vtable[655]
	virtual void Simulate(IPhysicsMotionController *param_1, IPhysicsObject *param_2, floatparam_3, Vector *param_4, Vector *param_5); // vtable[656]
