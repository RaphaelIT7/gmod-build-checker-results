// Generated header
// Estimated minimum size: 0x2834 (10292) bytes, no debug info available
...
public:
	...
	void LandCommon(bool param_1); // size[280]
	...
	void GetDropoffFinishPosition(Vector param_1, CAI_BaseNPC *param_2, Vector param_3, Vector param_4); // size[567]
