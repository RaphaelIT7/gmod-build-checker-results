// Generated header
// Estimated minimum size: 0x2844 (10308) bytes
...
public:
	...
	void InputDropStrider(inputdata_t *param_1); // size[425]
	...
	void InputLandLeave(inputdata_t *param_1); // size[102]
	void InputLandTake(inputdata_t *param_1); // size[84]
	void InputHover(inputdata_t *param_1); // size[42]
	void InputDropAPC(inputdata_t *param_1); // size[438]
	...
	void FireCannonRound(); // size[734]
	void StopCannon(); // size[38]
	void DoCombatStuff(); // size[289]
	void InitCustomSchedules(); // size[58]
