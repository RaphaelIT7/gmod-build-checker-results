...
public:
	...
	void IdealGoalForMovement(Vector *param_1, Vector *param_2, float param_3, float param_4); // size[488]
	void VelocityToEvade(CBaseCombatCharacter *param_1); // size[570]
	void UpdateHead(float param_1); // size[30]
	...
	void Gib(); // size[305]
	void AttackDivebombCollide(float param_1); // size[277]
};
