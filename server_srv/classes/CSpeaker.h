...
public:
	...
	void InputTurnOn(inputdata_t *param_1); // size[49]
	void InputTurnOff(inputdata_t *param_1); // size[39]
	void InputToggle(inputdata_t *param_1); // size[106]
	void SpeakerThink(); // size[400]
