...
public:
	...
	virtual void Dust(); // vtable[5]
	virtual void MuzzleFlash(); // vtable[6]
	virtual void MetalSparks(); // vtable[7]
	virtual void EnergySplash(); // vtable[8]
	virtual void Ricochet(); // vtable[9]
