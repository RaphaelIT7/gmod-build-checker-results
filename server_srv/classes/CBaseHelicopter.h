// Generated header
// Estimated minimum size: 0x2700 (9984) bytes
...
public:
	...
	void InputEnableRotorWash(inputdata_t *param_1); // size[9]
	void InputDisableRotorWash(inputdata_t *param_1); // size[53]
	void GetBaseMap(); // size[10]
	CBaseHelicopter(); // size[18]
	void DoWashPushOnAirboat(CBaseEntity *param_1, Vector *param_2, float param_3); // size[750]
	void UpdateEnemy(); // size[429]
	...
	void InputMoveSpecifiedSpeed(inputdata_t *param_1); // size[404]
