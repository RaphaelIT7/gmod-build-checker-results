// Generated header
// Estimated minimum size: 0x26F4 (9972) bytes, no debug info available
...
public:
	...
	void InputDisableRotorWash(inputdata_t *param_1); // size[9]
	void GetBaseMap(); // size[10]
	CBaseHelicopter(); // size[18]
	void DoWashPushOnAirboat(CBaseEntity *param_1, Vector *param_2, float param_3); // size[929]
	void UpdateEnemy(); // size[27]
	void FireWeapons(); // size[142]
	void UpdatePlayerDopplerShift(); // size[565]
	void ComputeActualTargetPosition(float param_1, float param_2, float param_3, Vector *param_4, bool param_5); // size[335]
	void InputMoveTopSpeed(inputdata_t *param_1); // size[396]
	void InputMoveSpecifiedSpeed(inputdata_t *param_1); // size[408]
	void StopRotorWash(); // size[69]
	void InputKill(inputdata_t *param_1); // size[88]
	void GibMonster(); // size[5]
	void DoWashPush(washentity_t *param_1, Vector *param_2); // size[1723]
