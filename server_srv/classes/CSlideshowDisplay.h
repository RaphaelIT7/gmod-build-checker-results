...
public:
	...
	void InputSetDisplayText(inputdata_t *param_1); // size[111]
	...
	void ScreenVisible(boolparam_1); // size[181]
	void Disable(); // size[100]
	void InputDisable(inputdata_t *param_1); // size[9]
	void Enable(); // size[96]
	void InputEnable(inputdata_t *param_1); // size[9]
	void GetControlPanelInfo(intparam_1, char * *param_2); // size[14]
	void GetControlPanelClassName(intparam_1, char * *param_2); // size[14]
	void SpawnControlPanels(); // size[232]
