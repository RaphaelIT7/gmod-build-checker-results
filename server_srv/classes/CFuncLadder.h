...
public:
	...
	void GetLadder(int param_1); // size[32]
	...
	void GetDismount(int param_1); // size[74]
	void PlayerGotOff(CBasePlayer *param_1); // size[43]
	void DontGetOnLadder(); // size[15]
	void GetSurfacePropName(); // size[14]
	void GetBaseMap(); // size[10]
	void PlayerGotOn(CBasePlayer *param_1); // size[225]
	CFuncLadder(); // size[28]
