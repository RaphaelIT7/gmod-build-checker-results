...
public:
	...
	void Create(CBaseEntity *param_1, boolparam_2); // size[288]
	void InputIgnite(inputdata_t *param_1); // size[265]
	void SetLifetime(floatparam_1); // size[78]
	void SetUseHitboxes(boolparam_1); // size[81]
	void SetNumHitboxFires(intparam_1); // size[47]
	void SetHitboxFireScale(floatparam_1); // size[51]
