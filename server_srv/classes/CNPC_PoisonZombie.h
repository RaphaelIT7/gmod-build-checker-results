...
public:
	...
	void EnableCrab(intparam_1, boolparam_2); // size[65]
	void GetBaseMap(); // size[10]
	void EnableCrab(intparam_1, boolparam_2); // size[28]
	void RandomThrowCrab(); // size[66]
	void EvacuateNest(boolparam_1, floatparam_2, CBaseEntity *param_3); // size[281]
