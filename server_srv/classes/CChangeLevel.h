...
public:
	...
	void AddTransitionToList(levellist_t *param_1, intparam_2, char *param_3, char *param_4, edict_t *param_5); // size[228]
	void BuildChangeLevelList(levellist_t *param_1, intparam_2); // size[107]
	void ComputeEntitySaveFlags(CBaseEntity *param_1); // size[15]
	void AddDependentEntities(intparam_1, CBaseEntity * *param_2, int *param_3, intparam_4); // size[763]
	...
	void BuildEntityTransitionList(CBaseEntity *param_1, char *param_2, CBaseEntity * *param_3, int *param_4, intparam_5); // size[368]
	void ChangeList(levellist_t *param_1, intparam_2); // size[414]
