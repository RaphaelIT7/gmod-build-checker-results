...
public:
	...
	virtual void _ZThn9672_N15CNPC_RollerMine15CanInteractWithEP11CAI_BaseNPC(); // vtable[0]
	...
	void InputRespondToChirp(inputdata_t *param_1); // size[43]
	void Explode(); // size[714]
	void InputRespondToExplodeChirp(inputdata_t *param_1); // size[44]
	void GetStunDelay(); // size[40]
	void GetBaseMap(); // size[10]
	void Bury(CGameTrace *param_1); // size[528]
	void EmbedTouch(CBaseEntity *param_1); // size[235]
	void WakeupMine(CAI_BaseNPC *param_1); // size[72]
	void WakeNeighbors(); // size[413]
	void BecomePhysical(); // size[226]
	void GetHackedIdleSchedule(); // size[349]
	void SetRollerSkin(); // size[130]
	void Close(); // size[102]
	void IsPlayerVehicle(CBaseEntity *param_1); // size[109]
	void ShockTarget(CBaseEntity *param_1); // size[586]
	void ShockTouch(CBaseEntity *param_1); // size[608]
	void CloseTouch(CBaseEntity *param_1); // size[61]
	...
	void CountRollersOnMyVehicle(CUtlVector *param_1); // size[104]
	void AnnounceArrivalToOthers(CBaseEntity *param_1); // size[214]
	void StickToVehicle(CBaseEntity *param_1); // size[1251]
	void InputJoltVehicle(inputdata_t *param_1); // size[847]
