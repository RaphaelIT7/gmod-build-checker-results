...
public:
	...
	void StopRollingSound(); // size[49]
	void UpdateRollingSound(); // size[692]
	void StopPingSound(); // size[49]
	void UpdatePingSound(); // size[487]
	...
	void CountRollersOnMyVehicle(CUtlVector *param_1); // size[119]
	void AnnounceArrivalToOthers(CBaseEntity *param_1); // size[214]
	void StickToVehicle(CBaseEntity *param_1); // size[188]
