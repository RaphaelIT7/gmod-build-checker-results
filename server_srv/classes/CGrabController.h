// Generated header
// Estimated minimum size: 0x3488 (13448) bytes
...
public:
	...
	void DetachEntity(bool param_1); // size[1164]
	~CGrabController(); // size[33]
	void SetTargetPosition(Vector *param_1, QAngle *param_2); // size[174]
	void AttachEntity(CBasePlayer *param_1, CBaseEntity *param_2, IPhysicsObject *param_3, bool param_4, Vector *param_5, bool param_6); // size[2002]
	void ComputeError(); // size[376]
	void GetSavedMass(IPhysicsObject *param_1); // size[183]
	void UpdateObject(CBasePlayer *param_1, float param_2); // size[120]
};
