// Generated header
// Estimated minimum size: 0x598DFC4C (1502477388) bytes, no debug info available
...
public:
	...
	void AddOrUpdateFile(LuaFile *param_1, bool param_2); // size[1169]
	void SendFileToClient(int param_1, int param_2); // size[796]
	void OnFilesRequested(int param_1, bf_read *param_2, int param_3); // size[1043]
	void SendFileRequestRequest(int param_1); // size[150]
};
