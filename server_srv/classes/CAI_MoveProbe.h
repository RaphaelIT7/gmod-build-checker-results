...
public:
	...
	void CheckStep(CheckStepArgs_t *param_1, CheckStepResult_t *param_2); // size[3570]
	...
	void JumpMoveLimit(Vector *param_1, Vector *param_2, uint param_3, CBaseEntity *param_4, AIMoveTrace_t *param_5); // size[2494]
