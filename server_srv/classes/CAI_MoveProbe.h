// Generated header
// Estimated minimum size: 0x17A8 (6056) bytes, no debug info available
...
public:
	...
	void CheckStandPosition(Vector *param_1, uint param_2); // size[1697]
	...
	void OldCheckStandPosition(Vector *param_1, uint param_2); // size[264]
	...
	void JumpMoveLimit(Vector *param_1, Vector *param_2, uint param_3, CBaseEntity *param_4, AIMoveTrace_t *param_5); // size[383]
	...
	void MoveLimit(Navigation_t param_1, Vector *param_2, Vector *param_3, uint param_4, CBaseEntity *param_5, float param_6, uint param_7, AIMoveTrace_t *param_8); // size[1077]
};
