...
public:
	...
	void SpawnFullItem(CItem_DynamicResupply *param_1, CBasePlayer *param_2, int param_3); // size[191]
	void FindPotentialItems(int param_1, DynamicResupplyItems_t *param_2, int param_3, SpawnInfo_t *param_4); // size[454]
