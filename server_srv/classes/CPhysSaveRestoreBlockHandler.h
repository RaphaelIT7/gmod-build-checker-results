...
public:
	...
	virtual void AssociateModel(IPhysicsObject *param_1, intparam_2); // vtable[12]
	...
	void RestorePhysicsObjectAndModel(IRestore *param_1, PhysObjectHeader_t *param_2, QueuedItem_t *param_3, intparam_4); // size[848]
	...
	void NoteBBox(Vector *param_1, Vector *param_2, CPhysCollide *param_3); // size[1]
	void AssociateModel(IPhysicsObject *param_1, intparam_2); // size[7]
