...
public:
	...
	virtual void KeyValue(char *param_1, floatparam_2) override; // vtable[31]
	...
	virtual void KeyValue(char *param_1, Vectorparam_2); // vtable[246]

	void GetBaseMap(); // size[10]
	CBaseToggle(); // size[26]
	void LinearMove(Vector *param_1, floatparam_2); // size[41]
	void LinearMoveDone(); // size[52]
	void AngularMove(QAngle *param_1, floatparam_2); // size[89]
	void AngularMoveDone(); // size[66]
	void AxisValue(intparam_1, QAngle *param_2); // size[67]
	void AxisDir(); // size[121]
	void AxisDelta(intparam_1, QAngle *param_2, QAngle *param_3); // size[90]
};
