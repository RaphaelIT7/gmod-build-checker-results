...
public:
	...
	virtual void OnAttemptPhysGunPickup(CBasePlayer *param_1, PhysGunPickup_tparam_2); // vtable[390]
	virtual void OnPhysGunPickup(CBasePlayer *param_1, PhysGunPickup_tparam_2); // vtable[391]
	virtual void OnPhysGunDrop(CBasePlayer *param_1, PhysGunDrop_tparam_2); // vtable[392]
	virtual void ShouldPuntUseLaunchForces(PhysGunForce_tparam_1); // vtable[393]
	virtual void PhysGunLaunchAngularImpulse(); // vtable[394]
	virtual void PhysGunLaunchVelocity(Vector *param_1, floatparam_2); // vtable[395]
	...
	void OnAttemptPhysGunPickup(CBasePlayer *param_1, PhysGunPickup_tparam_2); // size[10]
	void ShouldPuntUseLaunchForces(PhysGunForce_tparam_1); // size[10]
	void PhysGunLaunchAngularImpulse(); // size[10]
	void PhysGunLaunchVelocity(Vector *param_1, floatparam_2); // size[10]
};
