// Generated header
// Estimated minimum size: 0x2240 (8768) bytes, no debug info available
...
public:
	...
	virtual ~CColorCorrectionSystem() override; // vtable[0]
	virtual ~CColorCorrectionSystem() override; // vtable[1]
