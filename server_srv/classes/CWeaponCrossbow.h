...
public:
	...
	void ToggleZoom(); // size[279]
	void CheckZoomToggle(); // size[84]
	void CreateChargerEffects(); // size[5]
	void SetSkin(int param_1); // size[114]
	void DoLoadEffect(); // size[456]
	void SetChargerState(ChargerState_t param_1); // size[703]
	void FireBolt(); // size[812]
