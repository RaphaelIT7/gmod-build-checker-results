...
public:
	...
	void Init(CBaseEntity *param_1, intparam_2); // size[20]
	...
	void StartFunction(intparam_1); // size[203]
	void Call(intparam_1, intparam_2); // size[70]
	void CallFunction(char *param_1); // size[176]
	void InitializeDataTables(); // size[121]
	void StartLua(); // size[770]
	void CallFunction(intparam_1); // size[214]
