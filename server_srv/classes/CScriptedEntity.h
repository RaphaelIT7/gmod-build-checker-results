...
public:
	...
	void Ready(); // size[58]
	void StartFunction(char *param_1); // size[203]
	void StartFunction(int param_1); // size[198]
	void Call(int param_1, int param_2); // size[70]
	void CallFunction(char *param_1, bool param_2); // size[144]
	void CallFunction(int param_1, bool param_2); // size[189]
	void InitializeDataTables(); // size[137]
	void StartLua(); // size[387]
