...
public:
	...
	virtual void OnPhysGunDrop(CBasePlayer *param_1, PhysGunDrop_tparam_2) override; // vtable[659]
	...
	virtual void OnAttemptPhysGunPickup(CBasePlayer *param_1, PhysGunPickup_tparam_2) override; // vtable[662]
	...
	virtual void PreThink(turretState_eparam_1); // vtable[675]
	virtual void Shoot(Vector *param_1, Vector *param_2, boolparam_3); // vtable[676]
	virtual void SetEyeState(eyeState_tparam_1); // vtable[677]
	...
	void ToggleUse(CBaseEntity *param_1, CBaseEntity *param_2, USE_TYPEparam_3, floatparam_4); // size[49]
	void SpinUp(); // size[5]
