// Generated header
// Estimated minimum size: 0x2724 (10020) bytes
...
public:
	...
	virtual void HasPreferredCarryAnglesForPlayer(CBasePlayer *param_1); // vtable[660]
	virtual void PreferredCarryAngles(); // vtable[661]
	virtual void OnAttemptPhysGunPickup(CBasePlayer *param_1, PhysGunPickup_t param_2); // vtable[662]
	virtual void Retire(); // vtable[663]
