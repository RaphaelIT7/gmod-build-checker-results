...
public:
	...
	virtual void SetMinimumSpeedLimit(float param_1); // vtable[104]
	virtual void SetMaximumSpeedLimit(float param_1); // vtable[105]

	void ApproachAscendingLadder(); // size[37]
	void ApproachDescendingLadder(); // size[13]
	void AscendLadder(); // size[563]
	void DescendLadder(); // size[256]
	void DismountLadderTop(); // size[81]
	void DismountLadderBottom(); // size[85]
	void TraverseLadder(); // size[180]
