...
public:
	...
	void ApproachAscendingLadder(); // size[34]
	void ApproachDescendingLadder(); // size[46]
	void AscendLadder(); // size[563]
	void DescendLadder(); // size[305]
	void DismountLadderTop(); // size[92]
	void DismountLadderBottom(); // size[91]
	void TraverseLadder(); // size[11]
