...
public:
	...
	virtual void Ignite(floatparam_1, CBaseEntity *param_2); // vtable[388]
	virtual void IsUseableEntity(CBaseEntity *param_1, uintparam_2); // vtable[389]
	...
	void DoThink(); // size[177]
	void GetBaseMap(); // size[10]
	NextBotCombatCharacter(); // size[73]
	void UseEntity(CBaseEntity *param_1, USE_TYPEparam_2); // size[112]
