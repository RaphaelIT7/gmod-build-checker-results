...
public:
	...
	virtual void SetHoldType() override; // vtable[381]
	virtual void ActivityOverride() override; // vtable[387]
	...
	CWeaponSWEP(); // size[0]
	void UpdateBurstSettings(); // size[0]
	void UpdateRestSettings(); // size[0]
