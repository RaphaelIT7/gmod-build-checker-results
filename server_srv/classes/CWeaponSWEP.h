...
public:
	...
	virtual void ActivityOverride(Activityparam_1, bool *param_2) override; // vtable[387]
	...
	virtual void GetFOV(floatparam_1) override; // vtable[421]
	virtual void OnRangeAttack1() override; // vtable[423]
	virtual void GModNPCAttackHack() override; // vtable[424]
	virtual void UpdateLuaData(boolparam_1); // vtable[429]
