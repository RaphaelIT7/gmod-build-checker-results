...
public:
	...
	void PauseActorsScenes(CBaseFlex *param_1, bool param_2); // size[315]
	void IsInInterruptableScenes(CBaseFlex *param_1); // size[177]
	void ResumeActorsScenes(CBaseFlex *param_1, bool param_2); // size[315]
	...
	void QueueRestoredSound(CBaseFlex *param_1, char *param_2, soundlevel_t param_3, float param_4); // size[121]
};
