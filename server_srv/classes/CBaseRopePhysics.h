...
public:
	...
	CBaseRopePhysics(CNode *param_1, int param_2, CRopeSpring *param_3, float *param_4); // size[407]
	void Restart(); // size[30]
	void ResetSpringLength(float param_1); // size[91]
	void GetSpringLength(); // size[24]
	void ResetNodeSpringLength(int param_1, float param_2); // size[28]
	void SetupSimulation(float param_1, IHelper *param_2); // size[41]
	void SetDelegate(IHelper *param_1); // size[14]
	void Simulate(float param_1); // size[59]
};
