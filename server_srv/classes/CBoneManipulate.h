...
public:
	...
	void ManipulateBone(int param_1, Vector *param_2, Quaternion *param_3); // size[101]
	void ScaleBone(int param_1, matrix3x4_t *param_2); // size[104]
	void SetBonePosition(uchar param_1, Vector *param_2, bool param_3); // size[249]
	void GetBonePosition(uchar param_1); // size[53]
	void SetBoneScale(uchar param_1, Vector *param_2, bool param_3); // size[235]
	...
	void GetJiggleInfo(uchar param_1); // size[10]
	void SetJiggle(uchar param_1, uchar param_2); // size[72]
