...
public:
	...
	void SpeculativelyCheckPush(PhysicsPushedInfo_t *param_1, Vector *param_2, boolparam_3); // size[121]
	void FinishPushers(); // size[106]
	void FinishPush(boolparam_1, RotatingPushMove_t *param_2); // size[229]
	...
	void RotateRootEntity(CBaseEntity *param_1, floatparam_2, RotatingPushMove_t *param_3); // size[527]
	void LinearlyMoveRootEntity(CBaseEntity *param_1, floatparam_2, Vector *param_3); // size[416]
	...
	void PerformRotatePush(CBaseEntity *param_1, floatparam_2); // size[491]
	void PerformLinearPush(CBaseEntity *param_1, floatparam_2); // size[443]
