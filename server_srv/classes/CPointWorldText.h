// Generated header
// Estimated minimum size: 0x14CC (5324) bytes
...
public:
	...
	void InputSetText(inputdata_t *param_1); // size[138]
	void InputEnable(inputdata_t *param_1); // size[86]
	...
	void InputSetEnabled(inputdata_t *param_1); // size[90]
