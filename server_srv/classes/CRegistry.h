...
public:
	...
	virtual void WriteInt(); // vtable[5]
	virtual void ReadString(); // vtable[6]
	virtual void WriteString(); // vtable[7]
	virtual void ReadInt(); // vtable[8]
	virtual void WriteInt(); // vtable[9]
	virtual void ReadString(); // vtable[10]
