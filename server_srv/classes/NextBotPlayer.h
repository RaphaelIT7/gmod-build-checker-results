...
public:
	...
	virtual void SetModelIndexOverride() override; // vtable[13]
	...
	virtual void SetOwnerEntity() override; // vtable[18]
	...
	virtual void KeyValue() override; // vtable[31]
	virtual void KeyValue() override; // vtable[32]
	virtual void GetKeyValue() override; // vtable[33]
	...
	virtual void AdjustDamageDirection() override; // vtable[65]
	...
	virtual void SetSpawnPoint(); // vtable[579]
	virtual void GetEntity(); // vtable[580]
	virtual void IsRemovedOnReset(); // vtable[581]
	virtual void IsDormantWhenDead(); // vtable[582]
	virtual void PressFireButton(); // vtable[583]
	virtual void ReleaseFireButton(); // vtable[584]
	virtual void PressAltFireButton(); // vtable[585]
	virtual void ReleaseAltFireButton(); // vtable[586]
	virtual void PressMeleeButton(); // vtable[587]
	virtual void ReleaseMeleeButton(); // vtable[588]
	virtual void PressUseButton(); // vtable[589]
	virtual void ReleaseUseButton(); // vtable[590]
	virtual void PressReloadButton(); // vtable[591]
	virtual void ReleaseReloadButton(); // vtable[592]
	virtual void PressForwardButton(); // vtable[593]
	virtual void ReleaseForwardButton(); // vtable[594]
	virtual void PressBackwardButton(); // vtable[595]
	virtual void ReleaseBackwardButton(); // vtable[596]
	virtual void PressLeftButton(); // vtable[597]
	virtual void ReleaseLeftButton(); // vtable[598]
	virtual void PressRightButton(); // vtable[599]
	virtual void ReleaseRightButton(); // vtable[600]
	virtual void PressJumpButton(); // vtable[601]
	virtual void ReleaseJumpButton(); // vtable[602]
	virtual void PressCrouchButton(); // vtable[603]
	virtual void ReleaseCrouchButton(); // vtable[604]
	virtual void PressWalkButton(); // vtable[605]
	virtual void ReleaseWalkButton(); // vtable[606]
	virtual void SetButtonScale(); // vtable[607]
	virtual void OnMainActivityComplete(); // vtable[608]
	virtual void OnMainActivityInterrupted(); // vtable[609]
	virtual void AvoidPlayers(); // vtable[610]
