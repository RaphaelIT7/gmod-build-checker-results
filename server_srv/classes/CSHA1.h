// Generated header
// Estimated minimum size: 0xB8 (184) bytes, no debug info available
...
public:
	...
	void Update(void *param_1, uint param_2); // size[248]
	void HashFile(char *param_1); // size[364]
	void Final(); // size[322]
	void ReportHash(char *param_1, uchar param_2); // size[334]
