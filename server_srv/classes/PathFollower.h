// Generated header
// Estimated minimum size: 0x47D4 (18388) bytes, no debug info available
...
public:
	...
	void Climbing(INextBot *param_1, Segment *param_2, Vector *param_3, Vector *param_4, float param_5); // size[8538]
	void JumpOverGaps(INextBot *param_1, Segment *param_2, Vector *param_3, Vector *param_4, float param_5); // size[476]
};
