...
public:
	...
	void ClientCommand(CBasePlayer *param_1, CCommand *param_2); // size[397]
	...
	void Update(double param_1); // size[166]
	void OnReceivedVoicePacket(CBaseEntity *param_1); // size[128]
