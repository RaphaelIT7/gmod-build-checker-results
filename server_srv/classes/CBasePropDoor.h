...
public:
	...
	virtual void DoorCanClose(boolparam_1); // vtable[325]
	...
	CBasePropDoor(); // size[144]
	void RegisterPrivateActivities(); // size[18]
	void UpdateAreaPortals(boolparam_1); // size[68]
	...
	void DoorOpen(CBaseEntity *param_1); // size[313]
	...
	void DoorClose(); // size[293]
	void InputClose(inputdata_t *param_1); // size[61]
	void InputToggle(inputdata_t *param_1); // size[79]
	void DoorActivate(); // size[123]
	void OnUse(CBaseEntity *param_1, CBaseEntity *param_2, USE_TYPEparam_3, floatparam_4); // size[845]
	void DoorAutoCloseThink(); // size[151]
