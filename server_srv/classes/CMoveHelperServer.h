...
public:
	...
	virtual void Con_NPrintf(int null, char const *null, ... null); // vtable[4]
	...
	virtual void IsWorldEntity(CBaseHandle *param_1); // vtable[11]
	virtual ~CMoveHelperServer(); // vtable[12]
	virtual ~CMoveHelperServer(); // vtable[13]
	virtual void SetHost(CBasePlayer *param_1); // vtable[14]
