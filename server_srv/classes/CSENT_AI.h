...
public:
	...
	virtual void SetUseType(intparam_1) override; // vtable[222]
	virtual void GetLuaScriptName() override; // vtable[224]
	virtual void InitializeScriptedEntity(char *param_1) override; // vtable[227]
	virtual void GMOD_CreateBoneFollowers(intparam_1, char * *param_2) override; // vtable[242]
	...
	virtual void SetSchedule(intparam_1) override; // vtable[423]
	virtual void TaskFail(intparam_1) override; // vtable[427]
	virtual void TaskFail(char *param_1) override; // vtable[428]
	virtual void TaskComplete(boolparam_1) override; // vtable[429]
	virtual void SetCondition(intparam_1) override; // vtable[450]
	...
	virtual void ScriptUse(CBaseEntity *param_1, CBaseEntity *param_2, USE_TYPEparam_3, floatparam_4); // vtable[710]
	...
	virtual void SetStepHeight(floatparam_1); // vtable[719]
