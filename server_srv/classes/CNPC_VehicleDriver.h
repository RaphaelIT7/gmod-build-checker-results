// Generated header
// Estimated minimum size: 0x2640 (9792) bytes, no debug info available
...
public:
	...
	void ClearWaypoints(); // size[100]
	void RecalculateSpeeds(); // size[134]
	void WaypointReached(); // size[570]
	void OverridePathMove(float param_1); // size[523]
	...
	void InputGotoPathCorner(inputdata_t *param_1); // size[68]
