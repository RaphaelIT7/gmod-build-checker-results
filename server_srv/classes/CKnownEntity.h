...
public:
	...
	virtual void GetLastKnownPosition(); // vtable[5]
	virtual void HasLastKnownPositionBeenSeen(); // vtable[6]
	virtual void MarkLastKnownPositionAsSeen(); // vtable[7]
	...
	virtual void GetTimeWhenBecameVisible(); // vtable[15]
