...
public:
	...
	void FindGroundAtPosition(Vector *param_1, float param_2, float param_3, Vector *param_4); // size[121]
	...
	void GetEntryPoint(int param_1, Vector *param_2, QAngle *param_3); // size[1391]
	...
	void GetNextCycleForInterval(int param_1, float param_2); // size[126]
	void LocalIntervalMovement(float param_1, bool *param_2, Vector *param_3, QAngle *param_4); // size[618]
