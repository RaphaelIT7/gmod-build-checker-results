...
public:
	...
	void CanExitVehicle(); // size[226]
	void FindGroundAtPosition(Vector *param_1, float param_2, float param_3, Vector *param_4); // size[1536]
	...
	void IsValidTransitionPoint(Vector *param_1, Vector *param_2); // size[1244]
	void FindExitSequence(); // size[451]
	void GetEntryPoint(int param_1, Vector *param_2, QAngle *param_3); // size[1618]
	...
	void SetTransitionSequence(int param_1); // size[47]
	void ReserveExitPoint(); // size[599]
