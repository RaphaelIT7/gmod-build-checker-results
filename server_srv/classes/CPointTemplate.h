...
public:
	...
	void GetTemplateIndexForTemplate(intparam_1); // size[27]
	void GetNumTemplateEntities(); // size[14]
	void GetTemplateEntity(intparam_1); // size[65]
	void FinishBuildingTemplates(); // size[59]
	void StartBuildingTemplates(); // size[307]
	void AddTemplate(CBaseEntity *param_1, char *param_2, intparam_3); // size[430]
