...
public:
	...
	void SoundPlayed(int param_1, char *param_2, soundlevel_t param_3, float param_4, int param_5, int param_6, Vector *param_7, double param_8, CUtlVector *param_9); // size[584]
