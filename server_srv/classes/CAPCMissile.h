...
public:
	...
	void Create(Vector *param_1, QAngle *param_2, Vector *param_3, CBaseEntity *param_4); // size[91]
	CAPCMissile(); // size[87]
	void Init(); // size[34]
	void AimAtSpecificTarget(CBaseEntity *param_1); // size[49]
	void IgniteDelay(); // size[93]
	void AugerDelay(floatparam_1); // size[81]
	void ExplodeDelay(floatparam_1); // size[68]
