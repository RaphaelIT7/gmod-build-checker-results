...
public:
	...
	virtual void AimHeadTowards(Vector *param_1, LookAtPriorityType param_2, float param_3, INextBotReply *param_4, char *param_5); // vtable[50]
	virtual void AimHeadTowards(CBaseEntity *param_1, LookAtPriorityType param_2, float param_3, INextBotReply *param_4, char *param_5); // vtable[51]
	...
	virtual void StartActivity(Activity param_1, uint param_2); // vtable[59]
	virtual void SelectAnimationSequence(Activity param_1); // vtable[60]
	virtual void GetActivity(); // vtable[61]
	virtual void IsActivity(Activity param_1); // vtable[62]
	virtual void HasActivityType(uint param_1); // vtable[63]
	virtual void SetDesiredPosture(PostureType param_1); // vtable[64]
	virtual void GetDesiredPosture(); // vtable[65]
	virtual void IsDesiredPosture(PostureType param_1); // vtable[66]
	virtual void IsInDesiredPosture(); // vtable[67]
	virtual void GetActualPosture(); // vtable[68]
	virtual void IsActualPosture(PostureType param_1); // vtable[69]
	virtual void IsPostureMobile(); // vtable[70]
	virtual void IsPostureChanging(); // vtable[71]
	virtual void SetArousal(ArousalType param_1); // vtable[72]
	virtual void GetArousal(); // vtable[73]
	virtual void IsArousal(ArousalType param_1); // vtable[74]
