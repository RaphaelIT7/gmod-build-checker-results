...
public:
	...
	virtual void SetKeyPosition(intparam_1, Vector *param_2); // vtable[2]
	virtual void InterpolatePosition(floatparam_1, Vector *param_2); // vtable[3]
	virtual void ProcessKey(char *param_1, char *param_2) override; // vtable[4]

	CPositionInterpolator_Rope(); // size[439]
};
