...
public:
	...
	void Launch(floatparam_1, string_tparam_2); // size[477]
	CGrenadePathfollower(); // size[70]
	void CreateGrenadePathfollower(string_tparam_1, string_tparam_2, Vector *param_3, QAngle *param_4, edict_t *param_5); // size[225]
