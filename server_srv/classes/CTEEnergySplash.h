...
public:
	...
	virtual ~CTEEnergySplash() override; // vtable[2]
	virtual ~CTEEnergySplash() override; // vtable[3]
	virtual void Test(Vector *param_1, QAngle *param_2) override; // vtable[4]

	_GLOBAL__sub_I_CTEEnergySplash(); // size[112]
	CTEEnergySplash(char *param_1); // size[25]
};
