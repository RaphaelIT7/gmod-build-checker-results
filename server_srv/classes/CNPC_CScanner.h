...
public:
	...
	void InputEquipMine(inputdata_t *param_1); // size[521]
	void SpotlightCreate(); // size[745]
	void GetBaseMap(); // size[10]
	void RequestInspectSupport(); // size[229]
	void IsValidInspectTarget(CBaseEntity *param_1); // size[224]
	void ClearInspectTarget(); // size[105]
	void SetInspectTargetToEnt(CBaseEntity *param_1, floatparam_2); // size[73]
	void InputClearFollowTarget(inputdata_t *param_1); // size[50]
	void SetInspectTargetToHint(CAI_Hint *param_1, floatparam_2); // size[108]
	void SetInspectTargetToPos(Vector *param_1, floatparam_2); // size[101]
	...
	void InspectTarget(inputdata_t *param_1, ScannerFlyMode_tparam_2); // size[232]
	...
	void SpotlightDestroy(); // size[116]
	void InputShouldInspect(inputdata_t *param_1); // size[179]
	void SpotlightCreate(); // size[89]
	void SpotlightTargetPos(); // size[292]
	void SpotlightCurrentPos(); // size[823]
	void SpotlightUpdate(); // size[507]
	void AttackPreFlash(); // size[207]
	void AttackFlash(); // size[168]
	void BlindFlashTarget(CBaseEntity *param_1); // size[407]
	void TakePhoto(); // size[465]
	void AttackFlashBlind(); // size[251]
	void MoveToSpotlight(floatparam_1); // size[316]
	void MoveToPhotograph(floatparam_1); // size[166]
	void BestInspectTarget(); // size[1243]
	void InitCustomSchedules(); // size[187]
	void LoadSchedules(); // size[62]
	CScheduleLoader(); // size[9]
	CNPC_CScanner(); // size[379]
};
