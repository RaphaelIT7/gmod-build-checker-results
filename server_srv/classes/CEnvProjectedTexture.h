...
public:
	...
	void InputSetSpotlightTexture(inputdata_t *param_1); // size[111]
	...
	void InputSetFOV(inputdata_t *param_1); // size[29]
	void InputSetLightColor(inputdata_t *param_1); // size[47]
