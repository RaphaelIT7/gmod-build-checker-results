// Generated header
// Estimated minimum size: 0x25D4 (9684) bytes

class CNPC_Puppet : public CAI_BaseNPC
{
public:
	virtual ~CNPC_Puppet() override; // vtable[0]
	virtual ~CNPC_Puppet() override; // vtable[1]
	...
	void InputSetAnimationTarget(inputdata_t *param_1); // size[259]
