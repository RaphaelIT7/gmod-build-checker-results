...
public:
	...
	virtual void SendViewModelMatchingSequence(intparam_1); // vtable[282]
	...
	virtual void AddEffects(intparam_1); // vtable[288]
	virtual void RemoveEffects(intparam_1); // vtable[289]
	...
	CBaseViewModel(); // size[413]
	void SetOwner(CBaseEntity *param_1); // size[151]
	void SetIndex(intparam_1); // size[47]
