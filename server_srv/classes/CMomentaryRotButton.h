...
public:
	...
	void UpdateTarget(floatparam_1, CBaseEntity *param_2); // size[66]
	...
	void UpdateTarget(floatparam_1, CBaseEntity *param_2); // size[31]
	void PlaySound(); // size[72]
	void UpdateSelf(floatparam_1, boolparam_2); // size[335]
};
