...
public:
	...
	void AccelerateThink(); // size[89]
	void GetBaseMap(); // size[10]
	CMissile(); // size[50]
	void SetGracePeriod(floatparam_1); // size[71]
	...
	void Explode(); // size[468]
	void AugerThink(); // size[287]
	void MissileTouch(CBaseEntity *param_1); // size[38]
	void SeekThink(); // size[870]
