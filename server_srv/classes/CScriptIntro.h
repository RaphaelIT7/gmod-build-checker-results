...
public:
	...
	void InputFadeTo(inputdata_t *param_1); // size[95]
	void InputSetNextFOV(inputdata_t *param_1); // size[59]
	void InputSetFOV(inputdata_t *param_1); // size[59]
	void BlendComplete(); // size[50]
	void InputSetCameraViewEntity(inputdata_t *param_1); // size[191]
	void InputSetBlendMode(inputdata_t *param_1); // size[59]
	void InputSetNextBlendTime(inputdata_t *param_1); // size[104]
	void InputSetFOVBlendTime(inputdata_t *param_1); // size[213]
	void InputSetFadeColor(inputdata_t *param_1); // size[95]
	void GetBaseMap(); // size[10]
	void GetIncludedPVSOrigin(Vector *param_1, CBaseEntity * *param_2); // size[55]
};
