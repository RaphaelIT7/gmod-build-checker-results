...
public:
	...
	void InputSetValueNoFire(inputdata_t *param_1); // size[165]
	void InputGetValue(inputdata_t *param_1); // size[65]
	void GetBaseMap(); // size[10]
	void UpdateOutValue(CBaseEntity *param_1, float param_2); // size[334]
	void InputSetValue(inputdata_t *param_1); // size[65]
	void InputSetHitMax(inputdata_t *param_1); // size[85]
	void InputSetHitMin(inputdata_t *param_1); // size[81]
	void InputAdd(inputdata_t *param_1); // size[77]
	void InputDivide(inputdata_t *param_1); // size[124]
	void InputMultiply(inputdata_t *param_1); // size[77]
	void InputSubtract(inputdata_t *param_1); // size[77]
};
