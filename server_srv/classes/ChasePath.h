// Generated header
// Estimated minimum size: 0x47F4 (18420) bytes, no debug info available
...
public:
	...
	void RefreshPath(INextBot *param_1, CBaseEntity *param_2, IPathCost *param_3, Vector *param_4); // size[5034]
};
