...
public:
	...
	void GetPosition(Hull_tparam_1, Vector *param_2); // size[157]
	void GetDirection(); // size[85]
	void Yaw(); // size[73]
	void IsInNodeFOV(CBaseEntity *param_1); // size[295]
	void HintMatchesCriteria(CAI_BaseNPC *param_1, CHintCriteria *param_2, Vector *param_3, float *param_4, boolparam_5, boolparam_6); // size[4195]
	void Lock(CBaseEntity *param_1); // size[127]
	void Unlock(floatparam_1); // size[53]
	void IsLockedBy(CBaseEntity *param_1); // size[75]
	void IsLocked(); // size[109]
	void HintMatchesCriteria(CAI_BaseNPC *param_1, CHintCriteria *param_2, Vector *param_3, float *param_4, boolparam_5, boolparam_6); // size[162]
	CAI_Hint(); // size[26]
	void GetNode(); // size[48]
	void DisableForSeconds(floatparam_1); // size[53]
	...
	void SetHintType(intparam_1, boolparam_2); // size[62]
};
