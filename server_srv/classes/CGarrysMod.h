...
public:
	...
	virtual void StartVideoScale(intparam_1, intparam_2) override; // vtable[2]
	virtual void EndVideoScale(intparam_1, intparam_2) override; // vtable[3]
	...
	void LevelInit(char *param_1, char *param_2, char *param_3, char *param_4, boolparam_5, boolparam_6); // size[17]
	...
	void EntityRemoved(CBaseEntity *param_1, boolparam_2); // size[50]
	void Think(); // size[85]
	~CGarrysMod(); // size[10]
	~CGarrysMod(); // size[10]
};
