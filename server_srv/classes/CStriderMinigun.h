...
public:
	...
	void StartShooting(IStriderMinigunHost *param_1, CBaseEntity *param_2, float param_3); // size[500]
	void ExtendShooting(float param_1); // size[44]
	void SetShootDuration(float param_1); // size[5]
	void IsPegged(int param_1); // size[155]
	void StopShootingForSeconds(IStriderMinigunHost *param_1, CBaseEntity *param_2, float param_3); // size[160]
	...
	void CanStartShooting(IStriderMinigunHost *param_1, CBaseEntity *param_2); // size[747]
	void Enable(IMinigunHost *param_1, bool param_2); // size[46]
	void Think(IStriderMinigunHost *param_1, float param_2); // size[2357]
};
