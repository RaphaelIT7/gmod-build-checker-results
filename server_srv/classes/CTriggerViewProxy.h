...
public:
	...
	CTriggerViewProxy(); // size[10]
	void Disable(); // size[121]
	void InputDisable(inputdata_t *param_1); // size[9]
	void InputTeleportPlayerToProxy(inputdata_t *param_1); // size[124]
	void GetPlayerOffset(); // size[727]
	void Move(); // size[629]
	void TranslateViewToProxy(); // size[869]
	void Enable(); // size[928]
