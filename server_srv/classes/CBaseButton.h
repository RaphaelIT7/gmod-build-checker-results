...
public:
	...
	void ButtonUse(CBaseEntity *param_1, CBaseEntity *param_2, USE_TYPEparam_3, floatparam_4); // size[351]
	void Press(CBaseEntity *param_1, BUTTON_CODEparam_2); // size[351]
