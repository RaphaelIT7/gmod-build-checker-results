...
public:
	...
	void GetBusyBehaviorForNPC(char *param_1, CBaseEntity *param_2, CBaseEntity *param_3, char *param_4); // size[67]
	void InputForceNPCToActBusy(inputdata_t *param_1); // size[94]
