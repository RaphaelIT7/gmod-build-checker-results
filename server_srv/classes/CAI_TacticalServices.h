...
public:
	...
	void FindLateralCover(Vector *param_1, Vector *param_2, float param_3, float param_4, int param_5, Vector *param_6); // size[421]
	...
	void FindLateralLos(Vector *param_1, Vector *param_2); // size[925]
