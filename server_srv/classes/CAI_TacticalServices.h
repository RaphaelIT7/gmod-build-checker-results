...
public:
	...
	void FindLateralCover(Vector *param_1, Vector *param_2, float param_3, float param_4, int param_5, Vector *param_6); // size[354]
	...
	void FindLos(Vector *param_1, Vector *param_2, float param_3, float param_4, float param_5, Vector *param_6); // size[44]
};
