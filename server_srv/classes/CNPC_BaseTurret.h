...
public:
	...
	void TurretUse(CBaseEntity *param_1, CBaseEntity *param_2, USE_TYPE param_3, float param_4); // size[162]
	void InputDeactivate(inputdata_t *param_1); // size[102]
	void InputActivate(inputdata_t *param_1); // size[74]
	void AutoSearchThink(); // size[63]
	void Initialize(); // size[429]
	void GetBaseMap(); // size[10]
	void SetTurretAnim(TURRET_ANIM param_1); // size[240]
	void Deploy(); // size[52]
	void MoveTurret(); // size[864]
	void ActiveThink(); // size[55]
	void SearchThink(); // size[78]
	void Retire(); // size[17]
	void TurretDeath(); // size[63]
};
