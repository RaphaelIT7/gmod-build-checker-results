...
public:
	...
	void GetCachedNode(Vector *param_1, Hull_t param_2, int *param_3); // size[278]
	void GetCachedNearestNode(Vector *param_1, CAI_BaseNPC *param_2, int *param_3); // size[111]
	...
	void CreateLink(int param_1, int param_2, CAI_DynamicLink *param_3); // size[208]
	void IsConnected(int param_1, int param_2); // size[118]
	~CAI_Network(); // size[303]
	void ListNodesInBox(CNodeList *param_1, int param_2, Vector *param_3, Vector *param_4, INodeListFilter *param_5); // size[420]
	void NearestNodeToPoint(CAI_BaseNPC *param_1, Vector *param_2, bool param_3, INearestNodeFilter *param_4); // size[2253]
