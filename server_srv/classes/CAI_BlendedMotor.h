...
public:
	...
	virtual void OverrideMaxYawSpeed(Activity param_1) override; // vtable[15]
	virtual void UpdateYaw(int param_1) override; // vtable[20]
	...
	void GetInteriorSequence(int param_1); // size[384]
	void ResetGoalSequence(); // size[144]
	void MoveContinue(); // size[221]
	void SetMoveScriptAnim(float param_1); // size[1404]
	void BuildInsertNode(int param_1, float param_2); // size[313]
	void BuildTurnScript(int param_1, int param_2); // size[561]
	void BuildTurnScript(AILocalMoveGoal_t *param_1); // size[1072]
	void InsertSlowdown(float param_1, float param_2, bool param_3); // size[389]
