...
{
public:
	virtual ~CBaseHLCombatWeapon() override; // vtable[0]
	virtual ~CBaseHLCombatWeapon() override; // vtable[1]
	...
	virtual void GetBulletSpread(WeaponProficiency_tparam_1) override; // vtable[339]
	virtual void GetSpreadBias(WeaponProficiency_tparam_1) override; // vtable[340]
	...
	virtual void CanLower() override; // vtable[409]
	...
	void GetDefaultProficiencyValues(); // size[10]
};
