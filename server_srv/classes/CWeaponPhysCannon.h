// Generated header
// Estimated minimum size: 0x4B74 (19316) bytes
...
public:
	...
	void FindObjectTrace(CBasePlayer *param_1, CGameTrace *param_2); // size[457]
	...
	void AttachObject(CBaseEntity *param_1, Vector *param_2); // size[54]
	...
	void PuntVPhysics(CBaseEntity *param_1, Vector *param_2, CGameTrace *param_3); // size[26]
