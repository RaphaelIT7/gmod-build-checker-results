...
public:
	...
	void NotifyEndUpdate(INextBot *param_1); // size[10]
	...
	void DebugFilterRemove(intparam_1); // size[98]
	void DebugFilterRemove(char *param_1); // size[72]
	NextBotManager(); // size[146]
	void Register(INextBot *param_1); // size[464]
	void DebugFilterAdd(intparam_1); // size[87]
	void DebugFilterAdd(char *param_1); // size[73]
