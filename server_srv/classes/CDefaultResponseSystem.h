...
public:
	...
	virtual void PrecacheResponses(boolparam_1) override; // vtable[4]
	...
	void Init(); // size[10]
	void BuildCustomResponseSystemGivenCriteria(char *param_1, char *param_2, AI_CriteriaSet *param_3, floatparam_4); // size[24]
