...
public:
	...
	void InitRagdollAttached(IPhysicsObject *param_1, Vector *param_2, int param_3, matrix3x4_t *param_4, matrix3x4_t *param_5, float param_6, int param_7, CBaseAnimating *param_8, int param_9, Vector *param_10, int param_11, Vector *param_12); // size[942]
};
