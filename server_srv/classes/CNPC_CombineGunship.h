...
public:
	...
	void GetGroundAttackHitPosition(); // size[205]
	...
	void DoGroundAttackExplosion(); // size[296]
	void StopGroundAttack(bool param_1); // size[535]
	void FindNearestGunshipCrash(); // size[573]
	...
	void StopCannonBurst(); // size[281]
	void SelfDestruct(); // size[70]
	void BeginDestruct(); // size[536]
