...
public:
	...
	virtual void SetSize(intparam_1); // vtable[5]
	virtual void SetOptions(uintparam_1); // vtable[6]
	...
	virtual void AddSection(IDataCacheClient *param_1, char *param_2, DataCacheLimits_t *param_3, boolparam_4); // vtable[9]
	virtual void RemoveSection(char *param_1, boolparam_2); // vtable[10]
	virtual void FindSection(char *param_1); // vtable[11]
	virtual void Purge(uintparam_1); // vtable[12]
	virtual void Flush(boolparam_1, boolparam_2); // vtable[13]
	virtual void OutputReport(DataCacheReportType_tparam_1, char *param_2) override; // vtable[14]

	void SortMemhandlesBySizeLessFunc(memhandle_t__ * *param_1, memhandle_t__ * *param_2); // size[66]
	CDataCache(); // size[143]
	void EnsureCapacity(uintparam_1); // size[232]
