...
public:
	...
	virtual void CreateConVar(char *param_1, char *param_2, char *param_3, intparam_4); // vtable[3]
	virtual void CreateConCommand(char *param_1, char *param_2, intparam_3, _func_void_CCommand_ptr *param_4, int_(*)(char_const*,char *param_5); // vtable[4]
