...
public:
	...
	void GetWritten(); // size[11]
	void WriteBuffer(Buffer *param_1); // size[70]
	void WriteString(string *param_1, bool param_2); // size[190]
	void ReadString(); // size[199]
	void MoveMem(ulonglong param_1, ulonglong param_2, ulonglong param_3); // size[143]
	void MoveMem(ulonglong param_1, ulonglong param_2, ulonglong param_3); // size[143]
	void TrimLeft(ulonglong param_1); // size[172]
};
