...
public:
	...
	virtual void Init(_func_void_ptr_char_ptr_int_ptr *param_1, bool param_2, IGet *param_3); // vtable[2]
	virtual void Shutdown(); // vtable[3]
	virtual void DumpStats(); // vtable[4]
	virtual void CreateLuaInterface(uchar param_1, bool param_2); // vtable[5]
	virtual void CloseLuaInterface(ILuaInterface *param_1); // vtable[6]
	virtual void GetLuaInterface(uchar param_1); // vtable[7]
	virtual void LoadFile(string *param_1, string *param_2, bool param_3, bool param_4); // vtable[8]
	...
	void AddSearchPath(char *param_1, char *param_2); // size[333]
	CLuaShared(); // size[193]
	...
	void LoadFile_FromDataTable(string *param_1, string *param_2, bool param_3); // size[1023]
};
