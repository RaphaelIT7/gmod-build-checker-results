...
public:
	...
	virtual void Stop(intparam_1); // vtable[5]
	...
	virtual void YieldWait(CThreadEvent * *param_1, intparam_2, boolparam_3, uintparam_4); // vtable[11]
	virtual void YieldWait(CJob * *param_1, intparam_2, boolparam_3, uintparam_4); // vtable[12]
	virtual void Yield(uintparam_1); // vtable[13]
	virtual void AddJob(CJob *param_1); // vtable[14]
	virtual void ExecuteHighPriorityFunctor(CFunctor *param_1); // vtable[15]
	virtual void ChangePriority(CJob *param_1, JobPriority_tparam_2); // vtable[17]
	virtual void ExecuteToPriority(JobPriority_tparam_1, _func_bool_CJob_ptr *param_2); // vtable[18]
	virtual void AbortAll(); // vtable[19]
	virtual void Reserved1(); // vtable[20]
	virtual void AddFunctorInternal(CFunctor *param_1, CJob * *param_2, char *param_3, uintparam_4); // vtable[21]
	virtual void GetDummyJob(); // vtable[22]
	virtual void Distribute(boolparam_1, int *param_2); // vtable[23]
	...
	~CDummyJob(); // size[71]
	~CDummyJob(); // size[7]
	void WaitForIdle(boolparam_1); // size[30]
