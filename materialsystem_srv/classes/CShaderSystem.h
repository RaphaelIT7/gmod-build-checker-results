...
public:
	...
	virtual void _ZN13CShaderSystem4InitEv(); // vtable[3]
	...
	virtual void ShaderStateString(int param_1); // vtable[10]
	...
	virtual void InitRenderState(IShader *param_1, int param_2, IMaterialVar * *param_3, ShaderRenderState_t *param_4, char *param_5); // vtable[16]
	...
	virtual void DrawSnapshot(bool param_1); // vtable[25]
	...
	void InitRenderStateFlags(ShaderRenderState_t *param_1, int param_2, IMaterialVar * *param_3); // size[14]
	...
	void DrawUsingMaterial(IMaterialInternal *param_1, VertexCompressionType_t param_2); // size[288]
	...
	CShaderSystem(); // size[78]
	void UnloadAllShaderDLLs(); // size[93]
	void SetupShaderDictionary(int param_1); // size[24]
	void LoadAllShaderDLLs(); // size[86]
