...
public:
	...
	virtual void IndexCount(); // vtable[28]
	virtual void GetMesh(); // vtable[29]
	virtual void Lock(); // vtable[30]
	virtual void Unlock(); // vtable[31]
	virtual void ModifyBegin(); // vtable[32]
	virtual void ModifyEnd(); // vtable[33]
	virtual void Spew(); // vtable[34]
	virtual void ValidateData(); // vtable[35]
