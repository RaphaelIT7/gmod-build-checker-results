...
public:
	...
	void CreateStaticMesh(); // size[2370]
	void ReportMorphStats(); // size[386]
	void RenderMorphQuads(IMatRenderContext *param_1, int param_2, int param_3, int param_4, int *param_5, MorphWeight_t *param_6); // size[1770]
	void BuildNonZeroMorphList(int *param_1, int param_2, MorphWeight_t *param_3); // size[187]
	void RenderMorphWeights(IMatRenderContext *param_1, int param_2, int param_3, MorphWeight_t *param_4); // size[518]
	...
	void BuildSegmentList(CUtlVector *param_1); // size[669]
	CMorph(); // size[251]
