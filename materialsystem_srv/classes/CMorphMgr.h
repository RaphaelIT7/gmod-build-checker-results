...
public:
	...
	virtual void AccumulateMorph(IMorphMgrRenderContext *param_1, IMorph *param_2, intparam_3, MorphWeight_t *param_4); // vtable[12]
	virtual void AdvanceFrame(); // vtable[13]
	virtual void GetMorphAccumulatorTexCoord(IMorphMgrRenderContext *param_1, Vector2D *param_2, IMorph *param_3, intparam_4); // vtable[14]
	...
	CMorphMgr(); // size[67]
	void ComputeWeightSubrect(int *param_1, int *param_2, int *param_3, int *param_4, intparam_5); // size[71]
	void ComputeAccumulatorSubrect(int *param_1, int *param_2, int *param_3, int *param_4, intparam_5); // size[71]
	void GetAccumulatorSubrectDimensions(int *param_1, int *param_2); // size[24]
	void GetAccumulator4TupleCount(); // size[10]
	void RegisterMorphSizeInBytes(intparam_1); // size[14]
	void GetTotalMemoryUsage(); // size[137]
	void Display32FTextureData(float *param_1, intparam_2, int *param_3, ITexture *param_4, intparam_5); // size[212]
