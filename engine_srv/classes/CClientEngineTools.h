...
public:
	...
	virtual void PostToolMessage(); // vtable[8]
	virtual void AdjustEngineViewport(); // vtable[9]
	virtual void SetupEngineView(); // vtable[10]
	virtual void SetupAudioState(); // vtable[11]
	virtual void VGui_PreRenderAllTools(); // vtable[12]
	virtual void VGui_PostRenderAllTools(); // vtable[13]
