...
public:
	...
	void GetCollidableFromDisplacementsInAABB(Vector *param_1, Vector *param_2); // size[1303]
	...
	void GetBrushesInAABB(Vector *param_1, Vector *param_2, CUtlVector *param_3, int param_4); // size[932]
