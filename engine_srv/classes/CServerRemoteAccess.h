...
public:
	...
	void BadPassword(CRConServer *param_1, uint param_2); // size[46]
	...
	void SendResponseToClient(uint param_1, ServerDataResponseType_t param_2, void *param_3, int param_4); // size[44]
	...
	void LookupValue(char *param_1, CUtlBuffer *param_2); // size[1580]
	void RequestValue(uint param_1, int param_2, char *param_3); // size[929]
	void WriteDataRequest(CRConServer *param_1, uint param_2, void *param_3, int param_4); // size[1591]
};
