...
public:
	...
	void DrawBatches(IMatRenderContext *param_1, IMesh *param_2, bool param_3); // size[5]
	void DrawFadedFragments(IMatRenderContext *param_1, int param_2, bool param_3); // size[5]
	void RenderOverlaysBatch(IMatRenderContext *param_1, int param_2, IMaterial *param_3); // size[5]
	...
	void CleanupMaterial(ushort param_1); // size[127]
	...
	void BuildStaticBuffers(); // size[2065]
	...
	void DoClipFragment(moverlayfragment_t *param_1, cplane_t *param_2, moverlayfragment_t * *param_3, moverlayfragment_t * *param_4); // size[1361]
	void Disp_DoClip(CDispInfo *param_1, CUtlVector *param_2, cplane_t *param_3, float param_4, int param_5, int param_6, int param_7, int param_8); // size[76]
