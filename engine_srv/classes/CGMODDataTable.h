...
public:
	...
	virtual void GetKey(intparam_1); // vtable[2]
	virtual void GetValue(intparam_1); // vtable[3]
	virtual void IncrementIterator(int *param_1); // vtable[4]
	virtual void Get(intparam_1); // vtable[5]
	virtual void Set(intparam_1, CGMODVariant *param_2); // vtable[6]
	virtual void HasKey(intparam_1); // vtable[7]
	...
	void Compare(bf_read *param_1, bf_read *param_2, CGMODDataTable *param_3, intparam_4); // size[1394]
	void Skip(bf_read *param_1); // size[218]
	void WriteProps(bf_read *param_1, bf_write *param_2, intparam_3); // size[1156]
	void Encode(void *param_1, bf_write *param_2); // size[558]
	CGMODDataTable(_func_void_void_ptr_int_CGMODVariant_ptr *param_1); // size[160]
	void Decode(void *param_1, bf_read *param_2); // size[302]
	void CopyFrom(void *param_1, void *param_2, CGMODDataTable *param_3); // size[397]
	~Entry(); // size[26]
};
