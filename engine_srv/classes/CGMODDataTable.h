// Generated header
// Estimated minimum size: 0x286864 (2648164) bytes, no debug info available
...
public:
	...
	void Compare(bf_read *param_1, bf_read *param_2, CGMODDataTable *param_3, int param_4); // size[1394]
