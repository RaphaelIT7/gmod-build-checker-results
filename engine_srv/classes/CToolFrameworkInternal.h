...
public:
	...
	virtual void Think(boolparam_1); // vtable[27]
	virtual void PostMessage(KeyValues *param_1); // vtable[28]
	virtual void GetSoundSpatialization(intparam_1, intparam_2, SpatializationInfo_t *param_3); // vtable[29]
	...
	virtual void VGui_PreRenderAllTools(intparam_1); // vtable[34]
	virtual void VGui_PostRenderAllTools(intparam_1); // vtable[35]
	...
	virtual void GetToolName(intparam_1); // vtable[42]
	virtual void SwitchToTool(intparam_1); // vtable[43]
	virtual void SwitchToTool(char *param_1); // vtable[44]
	virtual void IsTopmostTool(IToolSystem *param_1); // vtable[45]
	virtual void GetToolSystem(intparam_1); // vtable[46]
	virtual void GetTopmostTool(); // vtable[47]
	virtual void PostToolMessage(uintparam_1, KeyValues *param_2); // vtable[48]
	...
	void InvokeMethodInt(_func_void_int *param_1, intparam_2); // size[122]
