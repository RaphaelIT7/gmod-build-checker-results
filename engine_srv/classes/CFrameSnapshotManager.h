// Generated header
// Estimated minimum size: 0x1008C (65676) bytes, no debug info available
...
public:
	...
	void RemoveEntityReference(int param_1); // size[50]
	...
	void CreatePackedEntity(CFrameSnapshot *param_1, int param_2); // size[20]
	...
	void AddExplicitDelete(int param_1); // size[29]
	void CreateEmptySnapshot(int param_1, int param_2); // size[33]
	void TakeTickSnapshot(int param_1); // size[598]
