...
public:
	...
	virtual void GetBool(char *param_1, bool param_2); // vtable[6]
	virtual void GetInt(char *param_1, int param_2); // vtable[7]
	virtual void GetFloat(char *param_1, float param_2); // vtable[8]
	virtual void GetString(char *param_1, char *param_2); // vtable[9]
	virtual void SetBool(char *param_1, bool param_2); // vtable[10]
