...
public:
	...
	void AABBTree_Ray(Ray_t *param_1, Vector *param_2, CBaseTrace *param_3, bool param_4); // size[248]
	void AABBTree_BuildTreeTrisInSphere_r(Vector *param_1, float param_2, int param_3, ushort *param_4, ushort param_5); // size[592]
	...
	void SweepAABBTriIntersect(Ray_t *param_1, Vector *param_2, int param_3, CDispCollTri *param_4, CBaseTrace *param_5); // size[1215]
