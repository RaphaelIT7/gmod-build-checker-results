...
public:
	...
	virtual void StartRecording(char *param_1, bool param_2); // vtable[2]
	virtual void SetSignonState(int param_1); // vtable[3]
	...
	virtual void RecordUserInput(int param_1); // vtable[9]
	virtual void RecordMessages(bf_read *param_1, int param_2); // vtable[10]
