...
public:
	...
	IVP_Actuator_Spring(IVP_Environment *param_1, IVP_Template_Spring *param_2, IVP_ACTUATOR_TYPEparam_3); // size[46]
	void fire_event_spring_broken(); // size[68]
	IVP_Actuator_Spring(IVP_Environment *param_1, IVP_Template_Spring *param_2, IVP_ACTUATOR_TYPEparam_3); // size[286]
	void set_len(doubleparam_1); // size[49]
	void set_break_max_len(doubleparam_1); // size[49]
	void set_constant(doubleparam_1); // size[41]
	void set_damp(doubleparam_1); // size[41]
	void set_rel_pos_damp(doubleparam_1); // size[41]
