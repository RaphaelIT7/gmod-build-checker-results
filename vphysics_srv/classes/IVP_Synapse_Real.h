...
public:
	...
	void update_synapse(IVP_Compact_Edge *param_1, IVP_SYNAPSE_POLYGON_STATUSparam_2); // size[21]
	IVP_Synapse_Real(); // size[14]
	void init_synapse(IVP_Mindist *param_1, IVP_Real_Object *param_2, IVP_Compact_Edge *param_3, IVP_SYNAPSE_POLYGON_STATUSparam_4); // size[43]
