...
public:
	...
	virtual void ~CCollisionSolver() override; // vtable[2]
	virtual void ~CCollisionSolver() override; // vtable[3]
	...
	void environment_will_be_deleted();
	void max_collisions_exceeded_check_freezing();
	void max_collision_checks_exceeded();
	void ~CCollisionSolver();
	void ~CCollisionSolver();
	void max_contacts_exceeded_check_freezing();
	void inter_penetration();
