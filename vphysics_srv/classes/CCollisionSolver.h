...
public:
	...
	virtual void inter_penetration(IVP_Mindist *param_1, IVP_Real_Object *param_2, IVP_Real_Object *param_3, double param_4) override; // vtable[4]
	virtual void max_collisions_exceeded_check_freezing(IVP_Anomaly_Limits *param_1, IVP_Core *param_2) override; // vtable[5]
	virtual void max_collision_checks_exceeded(int param_1) override; // vtable[6]
	...
	virtual void max_contacts_exceeded_check_freezing(IVP_Core * *param_1, int param_2) override; // vtable[8]
	...
	void max_collision_checks_exceeded(int param_1); // size[28]
	~CCollisionSolver(); // size[104]
	~CCollisionSolver(); // size[112]
	void max_contacts_exceeded_check_freezing(IVP_Core * *param_1, int param_2); // size[10]
	void inter_penetration(IVP_Mindist *param_1, IVP_Real_Object *param_2, IVP_Real_Object *param_3, double param_4); // size[10]
