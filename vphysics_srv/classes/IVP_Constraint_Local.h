...
public:
	...
	virtual void fix_translation_axis(IVP_COORDINATE_INDEX param_1); // vtable[13]
	virtual void free_translation_axis(IVP_COORDINATE_INDEX param_1); // vtable[14]
	virtual void limit_translation_axis(IVP_COORDINATE_INDEX param_1, float param_2, float param_3); // vtable[15]
	virtual void change_max_translation_impulse(IVP_CONSTRAINT_FORCE_EXCEED param_1, float param_2); // vtable[16]
	...
	virtual void fix_rotation_axis(IVP_COORDINATE_INDEX param_1); // vtable[19]
	virtual void free_rotation_axis(IVP_COORDINATE_INDEX param_1); // vtable[20]
	virtual void limit_rotation_axis(IVP_COORDINATE_INDEX param_1, float param_2, float param_3); // vtable[21]
	virtual void change_max_rotation_impulse(IVP_CONSTRAINT_FORCE_EXCEED param_1, float param_2); // vtable[22]
