...
public:
	...
	void Init(char *param_1, uintparam_2, intparam_3, boolparam_4); // size[129]
	CPhysCollideCompactSurface(IVP_Compact_Surface *param_1); // size[61]
	CPhysCollideCompactSurface(char *param_1, uintparam_2, intparam_3, boolparam_4); // size[135]
	CPhysCollideCompactSurface(compactsurfaceheader_t *param_1, intparam_2, boolparam_3); // size[167]
};
