// Generated header
// Estimated minimum size: 0x15F0A4 (1437860) bytes
...
public:
	...
	void set_limits(float param_1, float param_2); // size[100]
	void set_friction(float param_1); // size[52]
	void set_motor(float param_1, float param_2); // size[55]
};
