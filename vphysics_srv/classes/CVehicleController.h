...
public:
	...
	virtual void GetWheel(int param_1); // vtable[8]
	virtual void GetWheelContactPoint(int param_1, Vector *param_2, int *param_3); // vtable[9]
	virtual void SetSpringLength(int param_1, float param_2); // vtable[10]
	virtual void SetWheelFriction(int param_1, float param_2); // vtable[11]
	virtual void OnVehicleEnter(); // vtable[12]
	virtual void OnVehicleExit(); // vtable[13]
	virtual void SetEngineDisabled(bool param_1); // vtable[14]
	...
	void CreateWheel(int param_1, vehicle_axleparams_t *param_2); // size[688]
	void CalcEngineTransmission(float param_1); // size[355]
	void CreateTraceData(int param_1, vehicle_axleparams_t *param_2); // size[473]
	void UpdateSkidding(bool param_1); // size[296]
	void UpdatePowerslide(vehicle_controlparams_t *param_1, bool param_2, float param_3); // size[491]
	void ResetState(); // size[207]
	CVehicleController(); // size[38]
	void AttachListener(); // size[29]
	void CreateWheel(int param_1, vehicle_axleparams_t *param_2); // size[55]
	void CreateTraceData(int param_1, vehicle_axleparams_t *param_2); // size[25]
	...
	void UpdateEngineTurboStart(vehicle_controlparams_t *param_1, float param_2); // size[169]
	void UpdateEngineTurboFinish(); // size[92]
	void UpdateHandbrake(vehicle_controlparams_t *param_1, float param_2, bool param_3, bool param_4); // size[272]
	void UpdateSkidding(bool param_1); // size[68]
	void UpdateExtraForces(); // size[470]
	void UpdateWheelPositions(); // size[38]
	void CalcSteering(float param_1, float param_2, float param_3, bool param_4); // size[467]
	void UpdateSteering(vehicle_controlparams_t *param_1, float param_2, float param_3); // size[98]
	void CalcEngineTransmission(float param_1); // size[28]
	void CalcEngine(float param_1, float param_2, bool param_3, float param_4, bool param_5); // size[1304]
