...
{
public:
	virtual void reset_time(IVP_Timeparam_1) override; // vtable[3]
	...
	void set_prime_orientation(IVP_U_Quat *param_1, IVP_Time *param_2, IVP_U_Quat *param_3, floatparam_4); // size[242]
};
