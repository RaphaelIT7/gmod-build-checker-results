...
public:
	...
	virtual void change_spawned_mindist_count(intparam_1); // vtable[11]
	virtual void get_spawned_mindist_count(); // vtable[12]

	void _GLOBAL__sub_I_mindist_rescue_push(); // size[1]
	void change_spawned_mindist_count(intparam_1); // size[51]
	...
	void recheck_recursive_childs(doubleparam_1); // size[327]
