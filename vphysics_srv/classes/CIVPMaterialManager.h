...
public:
	...
	virtual void get_material_by_index(IVP_Real_Object *param_1, IVP_U_Point *param_2, int param_3) override; // vtable[2]
	...
	void RemapIVPMaterialIndex(int param_1); // size[21]
	void SetPropMap(int *param_1, int param_2); // size[214]
};
