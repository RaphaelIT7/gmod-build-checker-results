...
public:
	...
	void try_to_generate_managed_friction(IVP_Friction_System * *param_1, IVP_BOOL *param_2, IVP_Simulation_Unit *param_3, IVP_BOOLparam_4); // size[17]
	void _GLOBAL__sub_I_try_to_generate_managed_friction(); // size[1]
	void try_to_generate_managed_friction(IVP_Friction_System * *param_1, IVP_BOOL *param_2, IVP_Simulation_Unit *param_3, IVP_BOOLparam_4); // size[989]
	IVP_Mindist(IVP_Environment *param_1, IVP_Collision_Delegator *param_2); // size[71]
	void print(char *param_1); // size[21]
	void hull_manager_is_reset(floatparam_1, floatparam_2); // size[32]
	void create_cp_in_advance_pretension(IVP_Real_Object *param_1, floatparam_2); // size[485]
	void update_exact_mindist_events(IVP_BOOLparam_1, IVP_MINDIST_EVENT_HINTparam_2); // size[1256]
	...
	void mindist_hull_limit_exceeded_event(floatparam_1); // size[1089]
	void get_synapse(intparam_1); // size[15]
	void get_sorted_synapse(intparam_1); // size[25]
