...
public:
	...
	virtual void get_all_ledges_within_radius(IVP_U_Point *param_1, doubleparam_2, IVP_Compact_Ledge *param_3, IVP_Real_Object *param_4, IVP_Compact_Ledge *param_5, IVP_U_BigVector *param_6); // vtable[4]
	...
	virtual ~IVP_SurfaceManager_Ball(); // vtable[9]
	virtual ~IVP_SurfaceManager_Ball(); // vtable[10]
