...
public:
	...
	virtual void mindist_entered_volume(IVP_Controller_Phantom *param_1, IVP_Mindist_Base *param_2); // vtable[0]
	virtual void mindist_left_volume(IVP_Controller_Phantom *param_1, IVP_Mindist_Base *param_2); // vtable[1]
	virtual void core_entered_volume(IVP_Controller_Phantom *param_1, IVP_Core *param_2); // vtable[2]
	virtual void core_left_volume(IVP_Controller_Phantom *param_1, IVP_Core *param_2); // vtable[3]
	virtual void phantom_is_going_to_be_deleted_event(IVP_Controller_Phantom *param_1); // vtable[4]
