...
public:
	...
	void set_force_factor(float param_1); // size[18]
	void set_damp_factor(float param_1); // size[18]
	void set_torque_factor(float param_1); // size[18]
	void set_angular_damp_factor(float param_1); // size[18]
};
