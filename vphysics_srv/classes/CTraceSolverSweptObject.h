// Generated header
// Estimated minimum size: 0xE4 (228) bytes
...
public:
	...
	CTraceSolverSweptObject(CGameTrace *param_1, ITraceObject *param_2, CTraceRay *param_3, CTraceIVP *param_4, Vector *param_5, uint param_6, IConvexInfo *param_7); // size[209]
