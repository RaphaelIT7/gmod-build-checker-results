...
public:
	...
	virtual void inter_penetration(IVP_Mindist *param_1, IVP_Real_Object *param_2, IVP_Real_Object *param_3, doubleparam_4); // vtable[2]
	virtual void max_collisions_exceeded_check_freezing(IVP_Anomaly_Limits *param_1, IVP_Core *param_2); // vtable[3]
	virtual void max_collision_checks_exceeded(intparam_1); // vtable[4]
	virtual void max_contacts_exceeded_check_freezing(IVP_Core * *param_1, intparam_2); // vtable[5]
	...
	IVP_Anomaly_Manager(IVP_BOOLparam_1); // size[20]
	void solve_inter_penetration_simple(IVP_Real_Object *param_1, IVP_Real_Object *param_2, doubleparam_3); // size[577]
};
