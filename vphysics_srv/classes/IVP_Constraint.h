...
public:
	...
	void free_translation_axis(IVP_COORDINATE_INDEX param_1); // size[16]
	void limit_translation_axis(IVP_COORDINATE_INDEX param_1, float param_2, float param_3); // size[16]
	void change_max_translation_impulse(IVP_CONSTRAINT_FORCE_EXCEED param_1, float param_2); // size[16]
	void change_rotation_axes_Ros(IVP_U_Matrix3 *param_1); // size[16]
	void fix_rotation_axis(IVP_COORDINATE_INDEX param_1); // size[16]
	void free_rotation_axis(IVP_COORDINATE_INDEX param_1); // size[16]
	void limit_rotation_axis(IVP_COORDINATE_INDEX param_1, float param_2, float param_3); // size[16]
	void change_max_rotation_impulse(IVP_CONSTRAINT_FORCE_EXCEED param_1, float param_2); // size[16]
