...
public:
	...
	virtual void CreateCmdLine(intparam_1, char * *param_2); // vtable[1]
	...
	virtual void ParmValue(char *param_1, intparam_2); // vtable[7]
	virtual void ParmValue(char *param_1, floatparam_2); // vtable[8]
	virtual void ParmCount(); // vtable[9]
	virtual void FindParm(char *param_1); // vtable[10]
	virtual void GetParm(intparam_1); // vtable[11]
	virtual void SetParm(intparam_1, char *param_2) override; // vtable[12]
	virtual ~CCommandLine(); // vtable[13]
	virtual ~CCommandLine(); // vtable[14]

	CCommandLine(); // size[28]
	void LoadParametersFromFile(char * *param_1, char * *param_2, intparam_3, boolparam_4); // size[345]
