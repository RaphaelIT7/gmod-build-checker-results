...
public:
	...
	void SetPriority(int param_1); // size[6]
	void Suspend(); // size[6]
	void Resume(); // size[6]
	void Terminate(int param_1); // size[7]
	void GetCurrentCThread(); // size[7]
	void Join(uint param_1); // size[9]
	~CThread(); // size[12]
	~CThread(); // size[7]
	void Stop(int param_1); // size[7]
	void Yield(); // size[6]
	void Sleep(uint param_1); // size[6]
	void WaitForCreateComplete(CThreadEvent *param_1); // size[7]
	void Start(uint param_1); // size[10]
};
