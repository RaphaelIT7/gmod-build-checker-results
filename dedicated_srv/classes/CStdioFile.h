...
public:
	...
	virtual void FS_setbufsize(uintparam_1); // vtable[2]
	virtual void FS_fclose(); // vtable[3]
	virtual void FS_fseek(longlongparam_1, intparam_2); // vtable[4]
	virtual void FS_ftell(); // vtable[5]
	virtual void FS_feof(); // vtable[6]
	virtual void FS_fread(void *param_1, uintparam_2, uintparam_3); // vtable[7]
	virtual void FS_fwrite(void *param_1, uintparam_2); // vtable[8]
	virtual void FS_setmode(FileMode_tparam_1); // vtable[9]
	...
	virtual void FS_fgets(char *param_1, intparam_2) override; // vtable[13]
