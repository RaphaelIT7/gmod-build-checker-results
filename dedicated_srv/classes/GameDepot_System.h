...
public:
	...
	virtual void SetMount(uintparam_1, boolparam_2); // vtable[3]
	...
	void MountAsSteampipe(Information *param_1, boolparam_2); // size[10]
	void Mount(Information *param_1, boolparam_2); // size[48]
