...
public:
	...
	virtual void AddFileToZip(char *param_1, char *param_2, eCompressionType param_3); // vtable[1]
	...
	virtual void AddBufferToZip(char *param_1, void *param_2, int param_3, bool param_4, eCompressionType param_5); // vtable[9]
