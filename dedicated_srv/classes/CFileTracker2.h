...
public:
	...
	void ListOpenedFiles(bool param_1, char *param_2, bool param_3); // size[766]
	void MarkAllCRCsUnverified(); // size[434]
	void GetUnverifiedFileHashes(CUnverifiedFileHash *param_1, int param_2); // size[232]
	...
	void NotePackFileAccess(char *param_1, char *param_2, int param_3, CPackedStoreFileHandle *param_4); // size[802]
	...
	void GetFilesToUnloadForWhitelistChange(IPureServerWhitelist *param_1); // size[16]
};
