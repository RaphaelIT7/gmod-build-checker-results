...
public:
	...
	virtual void Sleep(intparam_1); // vtable[3]
	virtual void GetExecutableName(char *param_1); // vtable[4]
	virtual void ErrorMessage(intparam_1, char *param_2); // vtable[5]
	virtual void WriteStatusText(char *param_1); // vtable[6]
	virtual void UpdateStatus(intparam_1); // vtable[7]
	virtual void LoadLibrary(char *param_1); // vtable[8]
	virtual void FreeLibrary(longparam_1); // vtable[9]
	...
	virtual void ConsoleInput(intparam_1, char *param_2, intparam_3); // vtable[13]
	virtual void Printf(char *param_1) override; // vtable[14]

	void dlsym(longparam_1, char *param_2); // size[5]
};
